...
class CtWatch < Sinatra::Base
    ...
    get '/health' do
        ...
        half 500, 'Log entries indexes and STH tree size have drifted, for at least one log server.' if sth_treesizes.zip(log_entries_indexes).all? { |a| (a[0][1].to_i - a[1][1].to_i).abs < 20000 }
